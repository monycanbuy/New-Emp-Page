...
using ServerLibrary.Services.Implementation;
...
builder.Services.AddScoped<IGenericRepositoryInterface<Gender>, GenderRepository>();

builder.Services.AddScoped<IGenericRepositoryInterface<Customer>, CustomerRepository>();
builder.Services.AddScoped<ICustRepository, CustRepository>();
builder.Services.AddScoped<IGenericRepositoryInterface<PaymentType>, PaymentTypeRepository>();
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowBlazorWasm",
        builder => builder
        .WithOrigins("http://localhost:5039", "https://localhost:7069")
            .AllowAnyMethod()
            .AllowAnyHeader()
            .AllowCredentials());
});
